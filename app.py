...
st_autorefresh(interval=3000, limit=None, key="eagle_eye_fix_v7")
...
def get_data_v7(full_code):
    try:
        ...
        # 资金流向模拟（红入绿出）
        fund_text = "+1.2亿" if pct >= 0 else "-0.8亿"
        ...
        sector_map = {
            "001896":"电力", "002364":"电力设备", 
            "600111":"稀土永磁", "002428":"小金属"
        }
    ...
    with st.container(border=True):
        ...
        with r1_l:
            ...
            <div style='line-height:1.2; margin-top:2px;'>
                <div><span class='badge b-score'>评分 90</span></div>
                <div style='font-size:16px; font-weight:bold; color:#f0f6fc;'>
                    {data['name']}
                    <span style='font-size:12px; color:#64748b; margin-left:5px;'>{data['code']}</span>
                </div>
            </div>
            """, unsafe_allow_html=True)
        with r1_m:
            st.markdown(f"""
            <div style='text-align:right; line-height:1.2; margin-top:10px;'>
        ...
        with r2_r:
            ...
            <div style='text-align:right; margin-top:20px;'>
                <span class='badge {data['fund_class']}' style='margin-bottom:3px;'>
                    资金：{data['fund_text']}
                </span>
                <br>
                <span class='badge b-sector'>{data['sector']}</span>
            </div>
            """, unsafe_allow_html=True)
